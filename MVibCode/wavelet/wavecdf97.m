...
%original by Tianhui Wang, modified by Lars Nockenberg (different filters)
...
%filters used are modified compared to original by Tianhui Wang:
%filters set global to avoid reinitialization at every call
global lp, global lpr, global hp, global hpr;
if(size(lp) == 0)
